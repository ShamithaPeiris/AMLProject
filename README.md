...
LankaAgri AI is a Machine Learning solution designed to predict the weekly market prices of vegetables and fruits in Sri Lanka. It combines historical price data with climate indicators (Rainfall, Temperature) to provide actionable insights for farmers, consumers, and policymakers.
